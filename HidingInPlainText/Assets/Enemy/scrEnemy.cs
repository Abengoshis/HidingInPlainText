...
public class scrEnemy : MonoBehaviour
{
	...
	void Start ()
	{
		...
		ChildGlowSmall.renderer.material.SetColor("_TintColor", new Color(1.0f, 0.0f, 0.0f, ChildGlowSmall.renderer.material.GetColor("_TintColor").a));
		ChildGlowLarge.renderer.material.SetColor("_TintColor", new Color(1.0f, 0.0f, 0.0f, ChildGlowLarge.renderer.material.GetColor("_TintColor").a));
